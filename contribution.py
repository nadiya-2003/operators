...
def calculate_contribution():
    X = int(input("Enter the salary of senior players (Rs): "))
    Y = int(input("Enter the salary of junior players (Rs): "))
    senior_players = 6
    junior_players = 5
    senior_contribution = (X * senior_players * 0.50)
    junior_contribution = (Y * junior_players * 0.40)
